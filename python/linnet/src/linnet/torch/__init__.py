...
def load(
    ...
    *,
    ...
    canonical definitions up to floating-point rounding. `numerics="fast"`
    additionally runs softmax, normalization, and attention in the input
    dtype instead of f32, as PyTorch reference implementations do.
