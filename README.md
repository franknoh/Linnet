...
| `stdlib/` | the standard library in Linnet: `std.linalg`, `std.nn` (linear, embedding, activations, softmax, norms, rope, attention, swiglu, argmax, kv cache, convolution, pooling), `std.random`, `std.quant` |
