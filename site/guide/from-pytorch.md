...
| Performance | native kernels | the same kernels from generated source, replayable as CUDA graphs, or XLA (Llama 3.1 8B decodes one request at 170 tok/s on an H100, transformers compiled at 103); see [Benchmarks](/benchmarks) |
